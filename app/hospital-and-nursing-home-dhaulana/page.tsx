      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-14 py-10 sm:py-14 md:py-20">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-14 xl:gap-16 lg:items-center mb-16 md:mb-24">
          <div className="lg:flex-1 lg:min-w-0 w-full order-2 lg:order-1">
            <nav className="inline-flex items-center gap-2 text-sm font-medium text-gray-500 mb-6">
              ...
              <span>/</span>
              <span className="text-[#9d174d] font-semibold">{t("footer.dhaulana")}</span>
            </nav>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-4">{t("dhaulana.intro1")}</p>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">{t("dhaulana.intro2")}</p>
            <p className="text-gray-800 text-base md:text-lg font-semibold border-l-4 border-[#9d174d] pl-5 mb-8">
              {t("dhaulana.mission")}
            </p>
            <div>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-4">{t("dhaulana.whyTitle")}</h2>
              <ul className="space-y-3">
                {["dhaulana.why1", "dhaulana.why2", "dhaulana.why3"].map((key, i) => (
          ...
          <div className="lg:w-[48%] xl:w-[50%] lg:max-w-[620px] w-full order-1 lg:order-2 mb-10 lg:mb-0">
            <div className="rounded-3xl overflow-hidden shadow-2xl shadow-gray-300/50 border border-gray-100 bg-white">
              <div className="relative w-full aspect-[4/3] min-h-[280px] sm:min-h-[340px] md:min-h-[400px]">
                <Image src="/medical.jpg" alt="Raj Nursing Home - Dhaulana" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 620px" priority />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:gap-14 xl:gap-16 lg:items-center mb-16 md:mb-24">
          <div className="lg:w-[48%] xl:w-[50%] lg:max-w-[620px] w-full order-1 mb-10 lg:mb-0">
            <div className="rounded-3xl overflow-hidden shadow-2xl shadow-gray-300/50 border border-gray-100 bg-white">
              <div className="relative w-full aspect-[4/3] min-h-[280px] sm:min-h-[340px] md:min-h-[400px]">
                <Image src="/Diagnostic3.jpg" alt="Diagnostic Centre - Dhaulana" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 620px" />
              </div>
            </div>
          </div>
          <div className="lg:flex-1 lg:min-w-0 w-full order-2">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">{t("dhaulana.whyTitle")}</h2>
            <p className="text-gray-600 text-base leading-relaxed mb-6">{t("dhaulana.whyEnd")}</p>
            <ul className="space-y-3 mb-6">
              {["dhaulana.why4", "dhaulana.why5", "dhaulana.why6", "dhaulana.why7"].map((key, i) => (
        ...
        <div className="flex flex-col lg:flex-row lg:gap-14 xl:gap-16 lg:items-start mb-16 md:mb-24">
          <div className="lg:flex-1 lg:min-w-0 w-full order-2 lg:order-1">
            ...
            <div className="mt-8 rounded-2xl bg-white p-6 shadow-md border border-gray-100">
              <h2 className="text-lg font-bold text-gray-900 mb-2">{t("dhaulana.ctaTitle")}</h2>
              <p className="text-gray-600 text-sm mb-4">{t("dhaulana.ctaPara")}</p>
              <a
          ...
          <div className="lg:w-[48%] xl:w-[50%] lg:max-w-[620px] w-full order-1 lg:order-2 mb-10 lg:mb-0">
            <div className="rounded-3xl overflow-hidden shadow-2xl shadow-gray-300/50 border border-gray-100 bg-white">
              <div className="relative w-full aspect-[3/4] min-h-[380px] sm:min-h-[460px] md:min-h-[520px]">
                <Image src="/laparoscopic2.jpg" alt="Laparoscopic Surgery - Dhaulana" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 620px" />
              </div>
            </div>
          </div>
        </div>
