...
export default function EditBlogPage() {
    ...
    fetch("/api/admin/blogs", { headers: { Authorization: `Bearer ${token}` } })
      ...
      .then((blogs: Record<string, unknown>[]) => {
        ...
        setForm({
          ...
          titleHi: (post.titleHi as string) || "",
          ...
          ytIframe: (post.ytIframe as string) || "",
          status: (post.status as boolean) ?? true,
        });
      })
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-black text-slate-800 mb-6">Edit Post</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 md:p-8 space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Use HTML for formatting: <p>, <h2>, <ul>, <li>, etc."
          />
        </div>
        ...
        <div className="flex gap-3 pt-2">
          ...
          >
            <Save className="w-4 h-4" /> {saving ? "Saving…" : "Edit Post"}
          </button>
          <Link
