            ...
            <div className="relative min-h-[380px] md:min-h-[460px] flex items-center">
                <div className="absolute inset-0 z-0 overflow-hidden">
                    <Image
                        ...
                        priority
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-[#800020] via-[#800020]/85 to-[#800020]/40 z-10" />
                </div>
                ...
                <div className="relative z-20 w-full max-w-[1420px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 py-14 md:py-20">
                    <div className="max-w-4xl space-y-6 md:space-y-8">
                        ...
                        <div className="flex flex-wrap items-center gap-4 md:gap-6 pt-2 pb-2">
                            <Link
                                href="#appointment"
                                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#800020] rounded-2xl font-black text-sm uppercase tracking-widest shadow-2xl hover:bg-rose-50 transition-all hover:-translate-y-0.5 border-2 border-transparent hover:border-white/50"
                            >
                                {t("womensHealth.bookCta")}
